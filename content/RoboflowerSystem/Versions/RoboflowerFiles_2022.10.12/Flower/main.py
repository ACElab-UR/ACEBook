...
while True:  # awaiting commands
    if mqtt.got_wakeup_message:
        ...
        routines.experiment(mqtt, led, cam, markers, feeder)  # runs function experiment from routines
    elif mqtt.got_prime_message:
        mqtt.got_prime_message = False
        feeder.do_prime()
    elif mqtt.got_learn_message:
        mqtt.got_learn_message = False
        routines.colonylearn(mqtt, led, cam, markers, feeder)  # runs function learn from routine
